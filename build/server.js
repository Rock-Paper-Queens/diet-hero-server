...
const coin_data_1 = require("./services/coin-data");
...
const start = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield coin_1.Coin.sync({ force: true });
        logger_1.default.info("All models were synchronized successfully.");
        yield coin_data_1.loadCoinList().then(() => {
            logger_1.default.info("scheduler has been scheduled ");
        });
        // scheduler({
